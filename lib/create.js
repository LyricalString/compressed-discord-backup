                        ...
                        switch (_c.label) {
                            case 0:
                                ...
                                categories = guild.channels.cache
                                    .filter(function (ch) { return ch.type === 'GUILD_CATEGORY'; })
                            ...
                            case 1:
                                ...
                                children = category.children.sort(function (a, b) { return a.position - b.position; }).toJSON();
                                _a = 0, children_1 = children;
                                _c.label = 2;
                            case 2:
                                if (!(_a < children_1.length)) return [3 /*break*/, 7];
                                child = children_1[_a];
                                if (!(child.type === 'GUILD_TEXT' || child.type === 'GUILD_NEWS')) return [3 /*break*/, 4];
                            ...
                            case 10:
                                ...
                                channel = others_1[_b];
                                if (!(channel.type === 'GUILD_TEXT' || channel.type === 'GUILD_NEWS')) return [3 /*break*/, 12];
