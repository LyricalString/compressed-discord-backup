...
var getBackupData = function (backupID) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        return [2 /*return*/, new Promise(function (resolve, reject) { return __awaiter(void 0, void 0, void 0, function () {
                var files, file, zlib, fs, unzip, read, write;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            if (file) {
                                ...
                                read = fs.createReadStream("" + backups + path_1.sep + file);
                                write = fs.createWriteStream("" + backups + path_1.sep + 'decompressed-' + file);
                                ...
                                setTimeout(function () {
                                    var data = require("" + backups + path_1.sep + 'decompressed-' + file);
                                    fs.unlinkSync("" + backups + path_1.sep + 'decompressed-' + file);
                                    resolve(data);
                                }, 3000);
                            }
                            else {
...
var create = function (guild, options) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, new Promise(function (resolve, reject) { return __awaiter(void 0, void 0, void 0, function () {
                    var intents, backupData_1, _a, _b, _c, _d, _e, _f, _g, backupJSON, zlib, gzip_1, fs_2, inp_1, out_1, e_1;
                    var _h;
                    return __generator(this, function (_j) {
                        switch (_j.label) {
                            ...
                            case 2:
                                ...
                                _j.label = 3;
                            case 3:
                                backupData_1.iconURL = guild.iconURL({ dynamic: true });
                                _j.label = 4;
                            case 4:
                            ...
                            case 5:
                                ...
                                _j.label = 6;
                            case 6:
                                backupData_1.splashURL = guild.splashURL();
                                _j.label = 7;
                            case 7:
                            ...
                            case 8:
                                ...
                                _j.label = 9;
                            case 9:
                                backupData_1.bannerURL = guild.bannerURL();
                                _j.label = 10;
                            case 10:
                            ...
                            case 18:
                                ...
                                backupJSON = options.jsonBeautify
                                    ? JSON.stringify(backupData_1, null, 4)
                                    : JSON.stringify(backupData_1);
                                // Save the backup
                                return [4 /*yield*/, promises_1.writeFile("" + backups + path_1.sep + backupData_1.id + "uncompressed.json", backupJSON, 'utf-8')];
                            case 19:
                                // Save the backup
                                _j.sent();
                                zlib = require('zlib');
                                gzip_1 = zlib.createGzip();
                                fs_2 = require('fs');
                                setTimeout(function () {
                                    inp_1 = fs_2.createReadStream("" + backups + path_1.sep + backupData_1.id + "uncompressed.json");
                                }, 3000);
                                setTimeout(function () {
                                    out_1 = fs_2.createWriteStream("" + backups + path_1.sep + backupData_1.id + ".json");
                                    inp_1.pipe(gzip_1).pipe(out_1);
                                    fs_2.unlinkSync("" + backups + path_1.sep + backupData_1.id + "uncompressed.json");
                                }, 3000);
                                _j.label = 20;
                            case 20:
                                // Returns ID
                                resolve(backupData_1);
                                return [3 /*break*/, 22];
                            case 21:
                                e_1 = _j.sent();
...
var load = function (backup, guild, options) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, new Promise(function (resolve, reject) { return __awaiter(void 0, void 0, void 0, function () {
                    var status, backupData_2, _a, e_2, e_3;
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            ...
                            case 7:
                                ...
                                loadMaster.loadConfig(guild, backupData_2).then(function () {
                                    loadMaster.loadRoles(guild, backupData_2).then(function () {
                                        loadMaster.loadChannels(guild, backupData_2, options).then(function () {
                                            loadMaster.loadAFK(guild, backupData_2).then(function () {
                                                loadMaster.loadEmojis(guild, backupData_2).then(function () {
                                                    loadMaster.loadBans(guild, backupData_2).then(function () {
                                                        loadMaster.loadEmbedChannel(guild, backupData_2).then(function () {
                                                        });
                                                    });
                                                });
                                            });
                            ...
                            return [2 /*return*/, resolve(backupData_2)];
                            case 10:
                                e_3 = _b.sent();
